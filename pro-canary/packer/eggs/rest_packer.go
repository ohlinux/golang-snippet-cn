...
//curl -i  -H 'Content-Type: application/json' -H 'Accept: application/json' -u orp:orp -X POST -d {"Modules":[{"Name":"nginx","Version":1},{"Name":"mysql","Version":2}]}' http://127.0.0.1:8080/packer
type Packer struct {
